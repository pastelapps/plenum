...
/**
 * Last Page — Closing
 * Investment info, included items, testimonials, partner logos, contact
 */
  ...
  return h('div', {
          ...
          h('div', {
            ...
            ...(course.included_items || []).map((item) =>
              h('div', {
                ...
                h('span', {
                  style: { fontSize: 16, fontFamily: body, color: '#ffffffdd' },
                }, item.text),
              ),
            ),
          ),
    ...
    h('div', {
      ...
      company.phones && company.phones.length > 0
        ? h('span', {
            style: { fontSize: 13, fontFamily: body, color: '#ffffffaa' },
